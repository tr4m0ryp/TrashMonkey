"""Threshold-tuner entrypoint: ``python -m yolo_waste_sorter.models.thresholds``.

All logic lives in ``yolo_waste_sorter.models.thresholding``; this module is
the stable import path -- the Jetson runtime (015) does
``from yolo_waste_sorter.models.thresholds import REST, ThresholdParams,
...
from yolo_waste_sorter.models.thresholding import (
    MAX_WRONG_BIN,
    REST,
    Decision,
    RestType,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m yolo_waste_sorter.models.thresholds",
    ...
    from yolo_waste_sorter.models.evaluation import load_report
