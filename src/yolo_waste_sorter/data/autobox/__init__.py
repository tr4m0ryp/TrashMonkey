...
from yolo_waste_sorter.data.autobox.birefnet import BIREFNET_SESSION, build_birefnet_backend
from yolo_waste_sorter.data.autobox.chain import (
    IMAGE_SUFFIXES,
    PROVENANCE_FILENAME,
    box_directory,
)
from yolo_waste_sorter.data.autobox.dino import build_dino_backend
from yolo_waste_sorter.data.autobox.geometry import (
    center_box,
    clamp_box,
