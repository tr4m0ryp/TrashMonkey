"""End-to-end smoke harness (task 016): ``python -m yolo_waste_sorter.smoke``.
...
from yolo_waste_sorter.smoke.cli import main
from yolo_waste_sorter.smoke.fakes import install_fake_ultralytics
from yolo_waste_sorter.smoke.fixtures import generate_fixtures
