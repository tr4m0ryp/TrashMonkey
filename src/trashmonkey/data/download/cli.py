"""CLI: python -m trashmonkey.data.download [--source NAME] [--force]"""
...
from trashmonkey.data.download.errors import DatasetConfigError, DownloadError
from trashmonkey.data.download.pipeline import download_source
from trashmonkey.data.download.registry import load_registry
