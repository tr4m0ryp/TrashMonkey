"""CLI: python -m trashmonkey.data.pipeline run [--stage] [--force] [--ack-review] [--config]
...
from trashmonkey.data.download.errors import DownloadError
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m trashmonkey.data.pipeline",
