"""End-to-end smoke harness CLI (task 016): ``python -m trashmonkey.smoke``.
...
from trashmonkey.data.pipeline import PipelineContext, build_stages
from trashmonkey.smoke import fixtures, steps
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m trashmonkey.smoke",
        description=(
