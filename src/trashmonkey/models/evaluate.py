"""Evaluation entrypoint module: ``python -m trashmonkey.models.evaluate``.

All logic lives in ``trashmonkey.models.evaluation``; this module is the
stable import path (``from trashmonkey.models.evaluate import evaluate``)
and the CLI entry.
"""
...
from trashmonkey.models.evaluation import EvalReport, evaluate, load_report
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m trashmonkey.models.evaluate",
